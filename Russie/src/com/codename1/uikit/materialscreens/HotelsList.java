...
public class HotelsList extends SideMenuBaseForm
{
    Form f;
    String url2 = "/img";
    ...
    public HotelsList(Resources res)  
    {
        ...
        try 
        {
           db = Database.openOrCreate("Russia");
                if(created == true) db.execute("create table commenthotel (id INTEGER PRIMARY KEY AUTOINCREMENT, user TEXT, body TEXT, datec TEXT, idhotel INTEGER);");
                System.out.println("Table commenthotel was created.");
 ...
 System.out.println("Path of database: "+Database.getDatabasePath("Russia"));
        ...
        Label tit = new Label("Hôtels", "Title");
...
//gov.getAllStyles().setMargin(LEFT, 0);
        ...
        ArrayList<Hotels> p = sp.getList2();
            ...
            public void actionPerformed(ActionEvent e) 
            {
                    ...
                    public void actionPerformed(ActionEvent evt) {
                        ...
                        try {
                            if (isInputValid())
                            {
                                ...
                                db.execute("insert into commenthotel (user, body, datec, idhotel) values ('"+u.getUsername()+"', '"+nom+"', '"+str+"','"+pr.getId()+"' );");
                                ...
                                f2.revalidate();
                                HotelsList cl = new HotelsList(res);
                                cl.getF().show();
                            }
                        } catch (IOException ex)
                        {
                ...
                try {
                    Image placeholder = Image.createImage("/cmnt.png");
                        ...
                        f2.add(title);
                    Cursor c= db.executeQuery("select * from commenthotel where idhotel ="+pr.getId());
                   while (c.next()) 
                   {
                        Row r = c.getRow();
                    ...
                    public void actionPerformed(ActionEvent evt) {
                        ...
                        try {
                            if (isInputValid())
                            {
                                ...
                                Date dt = new Date();
                                String str = new SimpleDateFormat("dd/MM/yyyy : HH:mm").format(dt);
                                db.execute("UPDATE commenthotel SET body ='"+nom+"',datec ='"+str+"' WHERE idhotel='" + pr.getId() + "' AND user='" + u.getUsername() + "' ");
                                System.out.println(pr.getId());
                                System.out.println(pr.getNom());
                                System.out.println(u.getId());
                                System.out.println(u.getUsername());
                        ...
                        public void actionPerformed(ActionEvent evt) 
                        {
                            try 
                            {
                                ...
                                db.execute("DELETE from commenthotel WHERE idhotel='" + pr.getId() + "' AND user='" + u.getUsername() + "' ");
        ...
        f.show();
                        ...
                        Label ville = new Label(pr.getHotelVille().getNom());
