...
public class RestosList extends SideMenuBaseForm
{
    Form f;
    String url2 = "/img";
    ...
    TextField tfNom;
    String prenom;
    public RestosList(Resources res)  
    {
        created = Database.exists("Russia");
        try 
        {
           db = Database.openOrCreate("Russia");
                if(created == true) db.execute("create table commentresto (id INTEGER PRIMARY KEY AUTOINCREMENT, user TEXT, body TEXT, datec TEXT, idresto INTEGER);");
                System.out.println("Table commentresto was created.");
 ...
 System.out.println("Path of database: "+Database.getDatabasePath("Russia"));
        ...
        f = new Form("Restaurants", BoxLayout.y());
        ...
        Label tit = new Label("Restaurants", "Title");
...
//gov.getAllStyles().setMargin(LEFT, 0);
        ...
        ServiceResto sp = new ServiceResto();
        ArrayList<Restos> p = sp.getList2();
            ...
            public void actionPerformed(ActionEvent e) 
            {
                    ...
                    public void actionPerformed(ActionEvent evt) {
                        ...
                        try {
                            if (isInputValid())
                            {
                                ...
                                db.execute("insert into commentresto (user, body, datec, idresto) values ('"+u.getUsername()+"', '"+nom+"', '"+str+"','"+pr.getId()+"' );");
                                ...
                                f2.revalidate();
                                RestosList cl = new RestosList(res);
                                cl.getF().show();
                            }
                        } catch (IOException ex)
                        {
                ...
                try {
                    Image placeholder = Image.createImage("/cmnt.png");
                        ...
                        f2.add(title);
                    Cursor c= db.executeQuery("select * from commentresto where idresto ="+pr.getId());
                   while (c.next()) 
                   {
                        Row r = c.getRow();
                    ...
                    public void actionPerformed(ActionEvent evt) {
                        ...
                        try {
                            if (isInputValid())
                            {
                                ...
                                Date dt = new Date();
                                String str = new SimpleDateFormat("dd/MM/yyyy : HH:mm").format(dt);
                                db.execute("UPDATE commentresto SET body ='"+nom+"',datec ='"+str+"' WHERE idresto='" + pr.getId() + "' AND user='" + u.getUsername() + "' ");
                                System.out.println(pr.getId());
                                System.out.println(pr.getNom());
                                System.out.println(u.getId());
                                System.out.println(u.getUsername());
                        ...
                        public void actionPerformed(ActionEvent evt) 
                        {
                            try 
                            {
                                ...
                                db.execute("DELETE from commentresto WHERE idresto='" + pr.getId() + "' AND user='" + u.getUsername() + "' ");
